        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 w-full md:w-auto">
          ...
          <div className="flex items-center gap-1 bg-slate-50 border border-slate-300 rounded-xl px-2 py-1">
            ...
            <input
              ...
              className="w-12 text-xs font-bold text-slate-800 bg-transparent focus:outline-none"
            />
          </div>
          <select
            value={style}
          ...
          <div className="flex items-center gap-1 bg-slate-50 border border-slate-300 rounded-xl px-2 py-1">
            ...
            <input
              ...
              className="w-10 text-xs font-bold text-slate-800 bg-transparent focus:outline-none"
            />
          </div>
        </div>
      </div>
      ...
      {costData && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs">
              ...
              <div className="text-3xl font-bold text-emerald-700 mt-1">
                {costData.currencySymbol}{costData.costPerDayPerPerson.toLocaleString()} <span className="text-sm font-normal text-slate-500">/ day</span>
              </div>
              <p className="text-xs text-slate-500 mt-1">
          ...
          <div className="space-y-3">
            <h3 className="text-base font-bold text-slate-900">Expense Category Details</h3>
                ...
                <div key={idx} className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-2">
                      ...
                      <span className="font-extrabold text-sm text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-lg border border-emerald-200/60">
          ...
          {costData.savingTips && costData.savingTips.length > 0 && (
            <div className="bg-emerald-50/80 border border-emerald-200 rounded-2xl p-5">
              <div className="flex items-center gap-2 text-xs font-bold text-emerald-950 uppercase tracking-wider mb-2">
