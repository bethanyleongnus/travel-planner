    ...
    <div className="space-y-6 pb-16">
      ...
      {isLoading ? (
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-bold text-slate-800">{trip.totalCost}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 py-2 rounded-xl text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white transition flex items-center justify-center gap-1.5 cursor-pointer"
                  >
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 p-8 shadow-xs">
          ...
          <h3 className="font-bold text-slate-800 text-base mb-1">No Saved Trips Yet</h3>
          <p className="text-xs text-slate-500 max-w-md mx-auto mb-5">
            Head to the Itinerary Planner to create and save your personalized travel itineraries!
          </p>
          <button
            onClick={onNavigateToPlanner}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white transition cursor-pointer"
          >
