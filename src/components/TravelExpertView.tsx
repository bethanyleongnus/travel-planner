        ...
        <div className="space-y-5">
          ...
          {answerData.warningsOrScamsToAvoid && answerData.warningsOrScamsToAvoid.length > 0 && (
            <div className="bg-rose-50/70 border border-rose-200 rounded-2xl p-5">
              <div className="flex items-center gap-2 text-xs font-bold text-rose-950 uppercase tracking-wider mb-2">
              ...
              <div className="flex flex-wrap gap-2">
                {answerData.suggestedFollowUpQuestions.map((sug, i) => (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium bg-slate-50 hover:bg-emerald-50 hover:text-emerald-800 border border-slate-200 hover:border-emerald-300 transition cursor-pointer"
                  >
                    <span>{sug}</span>
